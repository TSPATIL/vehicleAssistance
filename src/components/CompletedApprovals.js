...
export default function CompletedApprovals(props) {
  const { approval, updateRejectedApprovals, viewApproval } = props
  return (
    <div className='col-md-3 my-3'>
            <div className="card" style={{width: '19rem'}}>
                <div className="card-body">
                    ...
                    <button className="btn btn-primary mx-2 col-5" onClick={()=>{updateRejectedApprovals(approval)}}>Rejected</button>
                </div>
            </div>
        </div>
  )
